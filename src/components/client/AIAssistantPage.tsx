...
export default function AIAssistantPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 64px)', maxWidth: 800, margin: '0 auto', padding: '16px 16px 0' }}>
      {/* Header */}
      ...
      {/* Input */}
      <div style={{ flexShrink: 0, paddingBottom: 16, paddingTop: 8, borderTop: '1px solid #e2e8f0', background: '#fff' }}>
        <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end' }}>
          <textarea
            ref={inputRef}
            value={input}

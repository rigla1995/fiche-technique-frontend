      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
            ...
            <h1 style={{ fontSize: '1.55rem', fontWeight: 900, color: '#fff', margin: 0, letterSpacing: '-0.02em' }}>{t('nav.catalogue_distinct')}</h1>
          </div>
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '0.85rem', margin: 0 }}>Ingrédients assignés à vos activités distinctes</p>
        </div>
      ...
      {activites.length === 0 ? (
        ...
        <>
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, marginBottom: 20, padding: '16px 20px', boxShadow: '0 2px 12px rgba(0,0,0,0.05)', display: 'flex', flexWrap: 'wrap', gap: 14, alignItems: 'flex-end' }}>
            {activites.length > 1 && (
              <div>
                <span style={{ fontSize: '0.68rem', fontWeight: 800, color: '#4338ca', textTransform: 'uppercase', letterSpacing: '0.07em', display: 'block', marginBottom: 5 }}>🏢 Activité</span>
